...
**Publishing day:** Mondays
**Auto-rebuild:** Daily at 6am CT via GitHub Action
**How it works:** Posts with future dates stay hidden. Jekyll's `future: false` setting keeps them invisible until their date arrives. The daily rebuild makes newly-due posts go live automatically.
...
| # | Date | Title | Keywords |
|---|------|-------|----------|
| 1 | Jan 15 | How to Calculate Peptide Dosing | peptide dosing, reconstitution |
| 2 | Jan 22 | How to Keep Track of Multiple Medications Without Losing Your Mind | track multiple medications, medication management |
| 3 | Feb 01 | What to Bring to Your Doctor's Appointment | doctor appointment prep |
| 4 | Feb 08 | How to Track Your Lab Results Over Time | lab results tracker, track lab results |
| 5 | Feb 12 | 5 Signs Your Medication Tracking Isn't Working | medication tracking tips |
| 6 | Feb 17 | How to Track Supplements Alongside Prescriptions | supplement tracker, supplements and prescriptions |
| 7 | Feb 22 | Setting Up a Health Tracking Routine That Sticks | health tracking routine |
| 8 | Mar 03 | 5 Things Your Pill Reminder App Should Do (But Probably Doesn't) | best medication reminder app, pill reminder app |
| 9 | Mar 10 | The Hidden Cost of Medications: Why You Should Track What You Spend | medication budget tracker, track medication costs |

## Scheduled (Written, Waiting to Go Live)
...
*No briefs pending. Plan next content batch when queue drops below 4 weeks of scheduled posts.*
